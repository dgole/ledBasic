...
strip.begin()
while True:
	lib.theaterChase(strip, Color(255, 0, 0))  # Red theater chase
	lib.theaterChase(strip, Color(0, 255, 0))  # Blue theater chase
	lib.theaterChase(strip, Color(0, 0, 255))  # Blue theater chase
	#lib.rainbow(strip)
